...
def main():
    ...
    profile_directory = r'C:\work\activity_project\youtube_comments\profiles\REDACTED_YOUTUBE_LOGIN'
    ...
    yt_auth = YoutubeAuthorization(login='REDACTED_YOUTUBE_LOGIN',
                                   password='REDACTED_YOUTUBE_PASSWORD',
